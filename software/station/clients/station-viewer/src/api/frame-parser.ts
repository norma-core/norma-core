...
import { yahboom_dogzilla_lite, drivers, inference, motors_mirroring, normvla, ov5647, st3215, sysinfo, usbvideo } from '@/api/proto.js';
...
type DecodedEntry = st3215.IInferenceState | st3215.ITxEnvelope | usbvideo.IRxEnvelope | ov5647.IRxEnvelope | motors_mirroring.IRxEnvelope | sysinfo.IEnvelope | yahboom_dogzilla_lite.IInferenceState | normvla.IFrame | null;
