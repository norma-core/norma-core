...
import { parseVescTrampaValuesPayload } from '@/modules/vesc-trampa/values-parser';
import { formatVescTrampaUuid, shortVescTrampaUuid } from '@/modules/vesc-trampa/utils';
import {
  EMPTY_STATE,
  applyEnvelope,
  type VictronState,
...
export interface RoverLiveViewProps {
...
const RoverLiveView = memo(function RoverLiveView({
  vesc,
  pwmOutputRx,
  pwmOutputTx,
  videoSources = [],
