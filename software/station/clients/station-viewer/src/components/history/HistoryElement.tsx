...
import { airgradient_open_air_o_1pst, arduino_nicla_sense_env, arduino_nicla_sense_me, hikmicro, ina226, usbvideo, st3215, motors_mirroring, sysinfo, yahboom_dogzilla_lite, normvla, vesc_trampa, victron_smartsolar_mppt, dfrobot_light_rs485 } from '@/api/proto.js';
import { formatBytes, parseUsbVideoData, parseHikmicroThermalData, parseMirroringData, parseSysinfoData, parseArduinoNiclaSenseEnvData, parseArduinoNiclaSenseMeData, parseIna226Data, parseAirGradientData, parseVictronSmartSolarData, parseYahboomDogzillaLiteData, parseNormvlaData, parseDfrobotLightRs485Data } from '@/components/history/history-utils';
