...
import { airgradient_open_air_o_1pst, arduino_nicla_sense_env, dmesg, hikmicro, ina226, usbvideo, st3215, motors_mirroring, sysinfo, yahboom_dogzilla_lite, normvla, vesc_trampa, victron_smartsolar_mppt, dfrobot_light_rs485 } from '@/api/proto.js';
...
function getAvailableTabs(
  ...
  if (isUsbVideo || isUsbVideoTx || isHikmicroThermal || isSt3215 || isSt3215Tx || isMirroring || isVescTrampaTx || isSysinfo || isArduinoNiclaSenseEnv || isIna226 || isDfrobotLightRs485 || isAirGradient || isVictronSmartSolar || isYahboomDogzillaLite || isNormvla) {
